...
#     tall_regression = make_regression(
#         n_samples=50000, n_features=200, n_informative=50)
...
#             self.wide_classification[0]), pd.DataFrame(
#             self.wide_classification[1])
#         train_data, test_data, train_target, test_target = train_test_split(
#             data, target)
#         self.melif.fit(train_data, train_target)
#         print(f1_score(test_target, self.melif.predict(test_data)))
...
#     def test_R(self):
#         data = pd.read_csv(
#             'C:\\Users\\SomaC\\PycharmProjects\\machinka\\mlrcheck\\boston_corrected.csv')
#         target = 'class'
